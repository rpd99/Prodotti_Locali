...
INSERT INTO categoria (nome, descrizione, img)  
VALUES ('Olio', 'Scopri la fragranza vibrante dei più pregiati extra-vergine locali, ottenuti da blend accuratamente combinati o da singole cultivar: estratte con metodi tradizionali entro poche ore dalla raccolta, le differenti varietà di olio extra-vergine d’oliva porteranno sulla tavola gli infiniti profumi e sapori della loro terra d’origine. Entra nei più antichi frantoi e ordina i condimenti perfetti da abbinare alle tue pietanze: sarà il produttore stesso a prepararli e spedirli direttamente a casa tua.', NULL);
INSERT INTO categoria (nome, descrizione, img)  
...
INSERT INTO categoria (nome, descrizione, img)  
VALUES ('Salumi', 'Scopri i salumi più pregiati, preparati ancora oggi proprio come si faceva una volta: facendo tesoro degli antichi saperi contadini, selezionando scrupolosamente la materia prima e lavorando i prodotti manualmente e con cura. Entra nei migliori laboratori e ordina le loro specialità: sarà il produttore stesso a prepararle e spedirle direttamente a casa tua.', NULL);
INSERT INTO categoria (nome, descrizione, img) 
...
INSERT INTO categoria (nome, descrizione, img)  
VALUES ('Torrone', 'Il torrone è un dolce italiano principalmente natalizio. È composto da albume d uovo, miele e zucchero, farcito con mandorle, noci, arachidi o nocciole tostate; spesso ricoperto da due strati d ostia. Il suo nome deriva dal verbo latino torrēre che significa abbrustolire con riferimento alla tostatura delle nocciole che lo compongono.', NULL);
INSERT INTO categoria (nome, descrizione, img) 
VALUES ('Vino', 'Scopri i vitigni più raffinati e le loro migliori annate sorseggiando i vini che hanno fatto e continuano ancora oggi a scrivere la storia dell enologia italiana. Scoprirai le peculiarità e l’identità che legano ogni vino al suo territorio, alle tecniche di coltivazione e ai processi di invecchiamento. Entra nelle migliori aziende vinicole e ordina le loro esclusive bottiglie: sarà il produttore stesso a confezionarle e spedirle direttamente a casa tua.', NULL);
...
INSERT INTO prodotto ( nome, descrizione, prezzo, peso, pezzi_disponibili, categoria) 
VALUES ('Carciofi', '', 14.99, 0.5, 3, 'sottoli');
INSERT INTO prodotto ( nome, descrizione, prezzo, peso, pezzi_disponibili, categoria) 
...
INSERT INTO prodotto ( nome, descrizione, prezzo, peso, pezzi_disponibili, categoria) 
VALUES ('Olive', 'Queste olive hanno straordinaria polposità e pur restando croccanti, dolcissime e succulente, speciali negli antipasti e come snack, una vera goduria da spizzicare in ogni momento della giornata.', 6.99, 1, 10, 'Conserve');
INSERT INTO prodotto ( nome, descrizione, prezzo, peso, pezzi_disponibili, categoria) 
...
INSERT INTO prodotto ( nome, descrizione, prezzo, peso, pezzi_disponibili, categoria)  
VALUES ('Greco di tufo', 'Il Greco di Tufo è una delle poche varietà bianche ad avere un’alta propensione all’invecchiamento.Questo antico e prestigioso vitigno è stato portato nella provincia di Avellino dai Pelagi, dalla Tessaglia in Grecia, nel primo secolo avanti Cristo', 11.90, 0.75, 7, 'Vino');
INSERT INTO prodotto ( nome, descrizione, prezzo, peso, pezzi_disponibili, categoria) 
...
INSERT INTO prodotto ( nome, descrizione, prezzo, peso, pezzi_disponibili, categoria)  
VALUES ('Fiano', 'Giallo paglierino con leggeri riflessi dorati. Offre moltissimi toni olfattivi, tra cui profumi di fiori bianchi, mela e pera, oltre all’inconfondibile sentore di nocciola tostata. All’assaggio conferma l’olfattiva, con la nocciola che domina nuovamente, accompagnando verso una chiusura fresca e minerale.', 11.90, 0.75, 7, 'Vino');
INSERT INTO prodotto ( nome, descrizione, prezzo, peso, pezzi_disponibili, categoria)  
