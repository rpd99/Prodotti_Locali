...
VALUES ('Miele', 'Il miele è un alimento prodotto dalle api (ed in misura minore, da altri imenotteri). Viene prodotto a partire dal nettare o dalla melata. La melata, con un gusto molto dolce simile allo zucchero, è prodotta da vari omotteri, fitomizi, i cui escrementi zuccherini sono la base alimentare per numerosi insetti. Il nettare è bottinato sui fiori di moltissime piante. Il miele in parte è usato come nutrimento dalle api e in parte è trasformato in cera d api per costruire le celle esagonali', NULL);
INSERT INTO categoria (nome, descrizione, img)  
VALUES ('Olio', 'Scopri la fragranza vibrante dei piu pregiati extra-vergine locali, ottenuti da blend accuratamente combinati o da singole cultivar: estratte con metodi tradizionali entro poche ore dalla raccolta, le differenti varieta'' di olio extra-vergine d''oliva porteranno sulla tavola gli infiniti profumi e sapori della loro terra d''origine. Entra nei piu''antichi frantoi e ordina i condimenti perfetti da abbinare alle tue pietanze: sarà  il produttore stesso a prepararli e spedirli direttamente a casa tua.', NULL);
INSERT INTO categoria (nome, descrizione, img)  
...
INSERT INTO prodotto ( nome, descrizione, prezzo, peso, pezzi_disponibili, categoria) 
VALUES ('Castagno', 'Gli alveari della apicoltura di questo tipo di miele sono collocati in aree boschive, o nelle vicinanze di aziende agricole ad agricoltura biologica, lontano da intense emissioni inquinanti, come citta'', strade, fabbriche, discariche.', 14, 0.4, 20, 'Miele');
...
INSERT INTO prodotto ( nome, descrizione, prezzo, peso, pezzi_disponibili, categoria) 
VALUES ('Tagliatelle', 'Pasta all uovo prodotta effettuando una meticolosa ricerca delle materie prime della più elevata qualita'', utilizzando soltanto semola di grano duro e uova fresche', 8, 1, 12, 'Pasta');
INSERT INTO prodotto ( nome, descrizione, prezzo, peso, pezzi_disponibili, categoria) 
...
INSERT INTO prodotto ( nome, descrizione, prezzo, peso, pezzi_disponibili, categoria) 
VALUES ('Carciofi', 'I carciofi alla contadina, grazie alla aggiunta del prezzemolo e del peperoncino i quali gli conferiscono un gusto saporito che rispecchia la migliore tradizione contadina italiana, ottimi in ogni occasione, come antipasto o come farcitura per torte salate e pizze.', 14.99, 0.5, 3, 'Conserve');
INSERT INTO prodotto ( nome, descrizione, prezzo, peso, pezzi_disponibili, categoria) 
VALUES ('Friarielli', 'La ricetta dei cosidetti Friarielli prevede che broccoli di prima qualita'' siano soffritti in olio extravergine di oliva insieme ad uno spicchio di aglio (per dare profumo) e del peperoncino, subito dopo essere stati scottati nell olio bollente, questi vengono conditi con un filo di olio extravergine a crudo e gustati da soli o accompagnati a delle salsicce, famosissimo è il piatto tipico campano Salsicce e Friarielli. Ingredienti: Broccoli 65%, olio extra vergine di oliva cultivar Ravece, aceto di vino, sale, peperoncino.', 9.99, 1, 30, 'Conserve');
INSERT INTO prodotto ( nome, descrizione, prezzo, peso, pezzi_disponibili, categoria)  
VALUES ('Melanzane', 'Ingredienti: Melanzane, Olio extravergine d''oliva, Aceto, Sale e Aromi naturali. Melanzane a filetto, una prelibata sinfonia di sapori della tradizione campana. Una volta aperto il vasetto, ricoprire di olio dopo ogni uso, e conservare possibilmente in frigorifero.', 5, 0.5, 9, 'Conserve');
INSERT INTO prodotto ( nome, descrizione, prezzo, peso, pezzi_disponibili, categoria) 
VALUES ('Olive', 'Queste olive hanno straordinaria polposita'' e pur restando croccanti, dolcissime e succulente, speciali negli antipasti e come snack, una vera goduria da spizzicare in ogni momento della giornata.', 6.99, 1, 10, 'Conserve');
INSERT INTO prodotto ( nome, descrizione, prezzo, peso, pezzi_disponibili, categoria) 
...
INSERT INTO prodotto ( nome, descrizione, prezzo, peso, pezzi_disponibili, categoria) 
VALUES ('Golosino', 'Torrone tenero al cioccolato e nocciole. Creato nel 1950, oggi è uno dei torroni morbidi piu'' apprezzati dalla clientela', 4.99, 0.14, 3, 'Torrone');
INSERT INTO prodotto ( nome, descrizione, prezzo, peso, pezzi_disponibili, categoria)  
